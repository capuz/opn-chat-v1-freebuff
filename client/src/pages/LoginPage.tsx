...
// ─── Google icon (used by GSI script) ─────────────────────────────────────

// The Google button is rendered by the GSI script — no custom SVG needed.
// Keeping GoogleIcon defined in case we need it for a custom button later.
const GoogleIcon = () => (
